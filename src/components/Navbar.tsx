        ...
        <div className="flex justify-between h-16">
          <div className="flex space-x-8 items-center">
            ...
            <div className="hidden md:flex space-x-6">
              ...
              <Link href="/notes" className="text-gray-700 hover:text-blue-600 transition-colors">
                学习笔记
              </Link>
              <Link href="/daily" className="text-gray-700 hover:text-blue-600 transition-colors">
                日常记录
              </Link>
          ...
          <div className="flex items-center space-x-4">
            {session ? (
              ...
              <button
                ...
                className="text-sm px-4 py-2 rounded-lg bg-gray-900 text-white hover:bg-gray-800 transition-colors flex items-center space-x-2"
              >
